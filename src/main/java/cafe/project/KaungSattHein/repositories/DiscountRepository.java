...
import cafe.project.KaungSattHein.repositories.mappers.resultsetextractors.DiscountListModelResultSetExctractor;
import cafe.project.KaungSattHein.repositories.mappers.resultsetextractors.DiscountResultSetExtractor;
...
@Repository
	public class DiscountRepository {
	    ...
	    public List<DiscountListModel> findAllForList() {
	        ...
	        return jdbcTemplate.query(sql, new DiscountListModelResultSetExctractor());
	    }
	}
