package cafe.project.HeinMinHtet.repositories.entities;
...
public class Orders{
	...
	public Orders(String order_id,String employee_id,String customer_id,
			...
			boolean isedited,boolean isdeleted,String order_type_id,BigDecimal total_amount,Integer token_number, String customer_address_id) {
